                ...
                <div class="auto-container">
                  <div class="content-box">
                        <div class="content">
                            <div class="clearfix">
                                <div class="inner">
                                    <div class="bg-image"><img src="{{ asset('assets/website') }}/images/main-slider/banner-bg-text.svg" alt="" title=""></div>
                                    <h2>Never Stop</h2>
                                    ...
                                    <div class="links-box clearfix">
                                        <div class="link"><a href="#" class="theme-btn btn-style-one"><span>View All Tours<i class="icon"><img src="{{ asset('assets/website') }}/images/icons/logo-icon.svg" alt="" title=""></i></span></a></div>
                                        <div class="link"><a href="https://www.youtube.com/watch?v=0xhr0j877bI" class="theme-btn lightbox-image"><i class="ripple"></i><span class="icon"><img src="{{ asset('assets/website') }}/images/icons/video-icon-1.svg" alt="" title=""></span></a></div>
                                    </div>
                                </div>
                        ...
                        <div class="banner-image">
                            <div class="image"><img src="{{ asset('assets/website') }}/images/main-slider/banner-image-1.svg" alt="" title=""></div>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="about-us">
    <div class="floated-icon right"><img src="{{ asset('assets/website') }}/images/resource/about-stone-right.svg" alt="" title=""></div>
    <div class="auto-container">
        <div class="row clearfix">
                ...
                <div class="inner wow fadeInRight" data-wow-duration="1500ms" data-wow-delay="0ms">
                    ...
                    <div class="lower-box">
                        <div class="lower-inner clearfix">
                            ...
                            <div class="image-box">
                                <img src="{{ asset('assets/website') }}/images/resource/about-image-2.jpg" alt="" title="">
            ...
            <div class="image-col col-lg-6 col-md-12 col-sm-12">
                <div class="inner wow fadeInLeft" data-wow-duration="1500ms" data-wow-delay="0ms">
                    <div class="bg-image">
                        <img src="{{ asset('assets/website') }}/images/resource/about-vector-1.png" alt="" title="">
                    </div>
                    <div class="image-box">
                        <img src="{{ asset('assets/website') }}/images/resource/about-image-1.svg" alt="" title="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="carousel-box">
            <div class="popular-carousel owl-theme owl-carousel">
                ...
                <div class="trek-block-one">
                    <div class="inner-box">
                        <div class="image-box">
                            <div class="image"><a href="packages.html"><img src="{{ asset('assets/website') }}/images/resource/f-image-1.jpg" alt="" title=""></a></div>
                            <div class="price"><span>${{$tour->price}}</span></div>
                            <div class="info">
                                <span class="i-block"><i class="icon far fa-clock"></i> {{$tour->price}} days</span> &ensp; |
                                    &ensp; <span class="i-block">{{$tour->last_booking_date}}</span>
                            </div>
                        </div>
                        ...
                        <div class="bottom-box clearfix">
                            <div class="more-link"><a href="{{route('tour.show', $tour->id)}}" class="theme-btn"><span>View Details <i class="icon"><img src="{{ asset('assets/website') }}/images/icons/logo-icon.svg" alt=""></i></span></a></div>
                            <div class="video-link"><a href="{{ route('wishlist.store', $tour->id) }}"
                                class="theme-btn"><i class="icon far fa-heart"></i></a></div>
                        </div>
                    </div>
                </div>
                @endforeach
        ...
        <div class="row clearfix">
            <div class="left-col col-xl-3 col-lg-4 col-md-6 col-sm-12">
                <div class="inner">
                    <div class="why-block">
                        <div class="inner-box">
                            <div class="icon-box"><img src="{{ asset('assets/website') }}/images/resource/icon-1.svg" alt=""></div>
                    ...
                    <div class="why-block">
                        <div class="inner-box">
                            <div class="icon-box"><img src="{{ asset('assets/website') }}/images/resource/icon-2.svg" alt=""></div>
                    ...
                    <div class="why-block">
                        <div class="inner-box">
                            <div class="icon-box"><img src="{{ asset('assets/website') }}/images/resource/icon-3.svg" alt=""></div>
            ...
            <div class="right-col col-xl-3 col-lg-4 col-md-6 col-sm-12">
                <div class="inner">
                    <div class="why-block">
                        <div class="inner-box">
                            <div class="icon-box"><img src="{{ asset('assets/website') }}/images/resource/icon-4.svg" alt=""></div>
                            <h4>Fast Booking</h4>
                            <div class="text">Richly varied landscapes, luxury accommodation Travel.</div>
                        </div>
                    </div>
                    <div class="why-block">
                        <div class="inner-box">
                            <div class="icon-box"><img src="{{ asset('assets/website') }}/images/resource/icon-5.svg" alt=""></div>
                            <h4>Support Team</h4>
                            <div class="text">Richly varied landscapes, luxury accommodation Travel.</div>
                        </div>
                    </div>
                    <div class="why-block">
                        <div class="inner-box">
                            <div class="icon-box"><img src="{{ asset('assets/website') }}/images/resource/icon-6.svg" alt=""></div>
            ...
            <div class="image-col col-xl-6 col-lg-4 col-md-12 col-sm-12">
                <div class="inner">
                    <div class="image-box"><img src="{{ asset('assets/website') }}/images/resource/why-image-1.svg" alt=""></div>
                </div>
            </div>
        ...
        <div class="gallery-box">
            <div class="masonry-container row clearfix">
                ...
                <div class="dest-block-one masonry-item col-lg-8 col-md-12 col-sm-12">
                    <div class="inner-box">
                        <div class="image-box"><a href="#"><img src="{{ asset('assets/website') }}/images/resource/gallery-1.jpg" alt=""></a></div>
                        <div class="hvr-box">
                            <div class="cap-box">
                ...
                <div class="dest-block-one masonry-item column-width col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="image-box"><a href="#"><img src="{{ asset('assets/website') }}/images/resource/gallery-2.jpg" alt=""></a></div>
                ...
                <div class="dest-block-one masonry-item col-lg-6 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="image-box"><a href="#"><img src="{{ asset('assets/website') }}/images/resource/gallery-3.jpg" alt=""></a></div>
                        <div class="hvr-box">
                            <div class="cap-box">
                                <div class="cap-inner clearfix">
                                    <h4><a href="tours.html">Rajasthan</a></h4>
                ...
                <div class="dest-block-one masonry-item col-lg-6 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="image-box"><a href="#"><img src="{{ asset('assets/website') }}/images/resource/gallery-4.jpg" alt=""></a></div>
                        <div class="hvr-box">
                            <div class="cap-box">
                                <div class="cap-inner clearfix">
                                    <h4><a href="tours.html">Rajasthan</a></h4>
                ...
                <div class="dest-block-one masonry-item column-width col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="image-box"><a href="#"><img src="{{ asset('assets/website') }}/images/resource/gallery-5.jpg" alt=""></a></div>
                        <div class="hvr-box alt-hvr">
                            <div class="cap-box">
                                <div class="cap-inner clearfix">
                                    <h4><a href="tours.html">Rajasthan</a></h4>
                ...
                <div class="dest-block-one masonry-item col-lg-8 col-md-12 col-sm-12">
                    <div class="inner-box">
                        <div class="image-box"><a href="#"><img src="{{ asset('assets/website') }}/images/resource/gallery-6.jpg" alt=""></a></div>
                        <div class="hvr-box">
                            <div class="cap-box">
                                <div class="cap-inner clearfix">
                                    <h4><a href="tours.html">Rajasthan</a></h4>
...
<section class="products-section">
    ...
    <div class="auto-container">
        ...
        <div class="row clearfix">
            ...
            <div class="prod-block col-xl-3 col-lg-4 col-md-6 col-sm-12">
                <div class="inner-box">
                    <div class="why-block">
                        <div class="image-box">
                            <div class="image"><a href="product-single.html"><img src="{{ asset('assets/website') }}/images/resource/shop/prod-1.jpg" alt=""></a></div>
                            <div class="hvr-box">
                                <div class="hvr-inner">
            ...
            <div class="prod-block col-xl-3 col-lg-4 col-md-6 col-sm-12">
                <div class="inner-box">
                    <div class="why-block">
                        <div class="image-box">
                            <div class="image"><a href="product-single.html"><img src="{{ asset('assets/website') }}/images/resource/shop/prod-2.jpg" alt=""></a></div>
                            <div class="hvr-box">
                                <div class="hvr-inner">
                                    <div class="hvr-content">
                                        <div class="link"><a href="product-single.html" class="theme-btn"><i class="far fa-shopping-cart"></i> Add To Cart</a></div>
            ...
            <div class="prod-block col-xl-3 col-lg-4 col-md-6 col-sm-12">
                <div class="inner-box">
                    <div class="why-block">
                        <div class="image-box">
                            <div class="image"><a href="product-single.html"><img src="{{ asset('assets/website') }}/images/resource/shop/prod-3.jpg" alt=""></a></div>
                            <div class="hvr-box">
                                <div class="hvr-inner">
                                    <div class="hvr-content">
                                        <div class="link"><a href="product-single.html" class="theme-btn"><i class="far fa-shopping-cart"></i> Add To Cart</a></div>
            ...
            <div class="prod-block col-xl-3 col-lg-4 col-md-6 col-sm-12">
                <div class="inner-box">
                    <div class="why-block">
                        <div class="image-box">
                            <div class="image"><a href="product-single.html"><img src="{{ asset('assets/website') }}/images/resource/shop/prod-4.jpg" alt=""></a></div>
                            <div class="hvr-box">
                                <div class="hvr-inner">
                                    <div class="hvr-content">
                                        <div class="link"><a href="product-single.html" class="theme-btn"><i class="far fa-shopping-cart"></i> Add To Cart</a></div>
            ...
            <div class="prod-block col-xl-3 col-lg-4 col-md-6 col-sm-12">
                <div class="inner-box">
                    <div class="why-block">
                        <div class="image-box">
                            <div class="image"><a href="product-single.html"><img src="{{ asset('assets/website') }}/images/resource/shop/prod-5.jpg" alt=""></a></div>
                            <div class="hvr-box">
                                <div class="hvr-inner">
                                    <div class="hvr-content">
                                        <div class="link"><a href="product-single.html" class="theme-btn"><i class="far fa-shopping-cart"></i> Add To Cart</a></div>
            ...
            <div class="prod-block col-xl-3 col-lg-4 col-md-6 col-sm-12">
                <div class="inner-box">
                    <div class="why-block">
                        <div class="image-box">
                            <div class="image"><a href="product-single.html"><img src="{{ asset('assets/website') }}/images/resource/shop/prod-6.jpg" alt=""></a></div>
                            <div class="hvr-box">
                                <div class="hvr-inner">
                                    <div class="hvr-content">
                                        <div class="link"><a href="product-single.html" class="theme-btn"><i class="far fa-shopping-cart"></i> Add To Cart</a></div>
            ...
            <div class="prod-block col-xl-3 col-lg-4 col-md-6 col-sm-12">
                <div class="inner-box">
                    <div class="why-block">
                        <div class="image-box">
                            <div class="image"><a href="product-single.html"><img src="{{ asset('assets/website') }}/images/resource/shop/prod-7.jpg" alt=""></a></div>
                            <div class="hvr-box">
                                <div class="hvr-inner">
                                    <div class="hvr-content">
                                        <div class="link"><a href="product-single.html" class="theme-btn"><i class="far fa-shopping-cart"></i> Add To Cart</a></div>
            ...
            <div class="prod-block col-xl-3 col-lg-4 col-md-6 col-sm-12">
                <div class="inner-box">
                    <div class="why-block">
                        <div class="image-box">
                            <div class="image"><a href="product-single.html"><img src="{{ asset('assets/website') }}/images/resource/shop/prod-8.jpg" alt=""></a></div>
                            <div class="hvr-box">
                                <div class="hvr-inner">
                                    <div class="hvr-content">
                                        <div class="link"><a href="product-single.html" class="theme-btn"><i class="far fa-shopping-cart"></i> Add To Cart</a></div>
        ...
        <div class="see-more-link"><a href="shop.html" class="theme-btn btn-style-one"><span>View All Products <i class="icon"><img src="{{ asset('assets/website') }}/images/icons/logo-icon.svg" alt="" title=""></i></span></a></div>
    </div>
</section>
                ...
                <div class="travel-block-one col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-box">
                        ...
                        <div class="content">
                            ...
                            <div class="link-box"><a href="#" class="theme-btn btn-style-one"><span>View Details <i class="icon"><img src="{{ asset('assets/website') }}/images/icons/logo-icon.svg" alt="" title=""></i></span></a></div>
                        </div>
                    </div>
                </div>
        ...
        <div class="carousel-box">
            <div class="testi-carousel owl-theme owl-carousel">
                ...
                <div class="testi-block">
                    <div class="inner-box">
                        <div class="icon"><img src="{{ asset('assets/website') }}/images/icons/quotes-1.svg" alt=""></div>
                        <div class="image"><img src="{{ asset('assets/website') }}/images/resource/testi-thumb-1.jpg" alt=""></div>
                ...
                <div class="testi-block">
                    <div class="inner-box">
                        <div class="icon"><img src="{{ asset('assets/website') }}/images/icons/quotes-1.svg" alt=""></div>
                        <div class="image"><img src="{{ asset('assets/website') }}/images/resource/testi-thumb-2.jpg" alt=""></div>
            ...
            <div class="row clearfix">
                ...
                <div class="news-block-one col-xl-4 col-lg-6 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="image-box">
                            <div class="image"><a href="blog-single.html"><img src="{{ asset('assets/website') }}/images/resource/news-1.jpg" alt="" title=""></a></div>
                ...
                <div class="news-block-one alternate col-xl-4 col-lg-6 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                        ...
                        <div class="image-box">
                            <div class="image"><a href="blog-single.html"><img src="{{ asset('assets/website') }}/images/resource/news-2.jpg" alt="" title=""></a></div>
                            <div class="cat"><span>Trekking</span></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="news-block-one col-xl-4 col-lg-6 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="image-box">
                            <div class="image"><a href="blog-single.html"><img src="{{ asset('assets/website') }}/images/resource/news-3.jpg" alt="" title=""></a></div>
                            <div class="cat"><span>Trekking</span></div>
                        </div>
                        <div class="lower-content">
                            <div class="info">
        ...
        <div class="content-box">
            ...
            <div class="row clearfix">
                <div class="image-col col-xl-5 col-lg-6 col-md-12 col-sm-12">
                    <div class="inner">
                        <div class="image"><img src="{{ asset('assets/website') }}/images/resource/newsletter-image.svg" alt=""></div>
                    </div>
                </div>
