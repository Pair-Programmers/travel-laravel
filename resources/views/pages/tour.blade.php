            ...
            <div class="mixitup-gallery">
                ...
                <div class="filter-list row clearfix">
                    @foreach ($tours as $tour)
                        <!--Block-->
                        <div
                            class="trek-block-one style-two mix all moderate m-difficult col-xl-4 col-lg-6 col-md-6 col-sm-12">
                            <div class="inner-box">
                                <div class="image-box">
                                    <div class="image"><a href="#"><img
                                                src="{{ asset('assets/website') }}/images/resource/f-image-1.jpg"
                                                alt="" title=""></a></div>
                                    <div class="price"><span>${{ $tour->price }}</span></div>
                                    <div class="info">
                                        <span class="i-block"><i class="icon far fa-clock"></i> {{ $tour->price }}
                                            days</span> &ensp; |
                                ...
                                <div class="bottom-box clearfix">
                                    <div class="more-link"><a href="{{ route('wishlist.store', $tour->id) }}"
                                            class="theme-btn"><span>View Details <i class="icon"><img
                                                        src="images/icons/logo-icon.svg" alt=""></i></span></a>
                                    </div>
