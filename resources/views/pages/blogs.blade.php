							...
							<div class="breadcrumbs__wrap">
								<div class="breadcrumbs__item">
									<a href="{{route('index')}}" class="breadcrumbs__item-link">Home</a> <span>/</span> <a
										href="blog.html" class="breadcrumbs__item-link">Blog Posts</a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-xs-12 col-md-8 col-lg-9 post-list">
					<article class="post-list__item format-standart">
						<figure class="thumbnail post-list__thumbnail">
							<a href="single-post.html"><img src="{{asset('assets/website')}}/images/blog-post-img-1.jpg" alt=""></a>
						</figure>
					...
					<article class="post-list__item format-video">
						...
						<div class="post-list__item-content">
							<header class="post-list__item-header">
								...
								<h3 class="post-list__item-title">An unlikely endorsement of rental cars from the star
									of Airplane!e</h3>
								<span class="post-list__item-author">by <a href="#">Paul Johnson</a></span>
							</header>
							<div class="post-list__item-desc">
					...
					<article class="post-list__item format-quote">
						<div class="post-list__item-content">
							<header class="post-list__item-header">
								...
								<h3 class="post-list__item-title">Premium Credit Cards That Offer Premium Car Rental
									Benefits</h3>
								<span class="post-list__item-author">by <a href="#">Paul Johnson</a></span>
							</header>
							<div class="post-list__item-desc">
								<p>Rental car companies have a vested interest in credit card users. After all, the
									companies need to get paid by consumers and the days of cash deposits are long gone.
								</p>

								<blockquote class="post-format-quote">
									<p>Debit cards are also viewed as undesirable by the rental car companies as a proxy
										for "non-creditworthy renter" (whether fair or unfair). Using debit cards
										frequently come with many restrictions, if the rental car company will even
										accept the debit card at all! Without multiple forms of identification, large
										security deposits, and a successful credit check (among other provisions), the
										car renter with a debit card will likely be taking a taxi or Uber instead.</p>
									<p>A search for a one-way rental at is almost identical to searching for a
										...
										International Airport rental? </p>
								</blockquote>
							</div>
							<footer class="post-list__item-footer">
								<a href="single-post.html" class="btn">READ POST</a>
						...
						<div class="swiper-container-slider-format swiper-container">
							<div class="swiper-wrapper">
								<figure class="thumbnail post-list__thumbnail swiper-slide">
									<img src="{{asset('assets/website')}}/images/blog-post-img-2.jpg" alt="">
								</figure>
								<figure class="thumbnail post-list__thumbnail swiper-slide">
									<img src="{{asset('assets/website')}}/images/blog-post-img-3.jpg" alt="">
								</figure>
								<figure class="thumbnail post-list__thumbnail swiper-slide">
									<img src="{{asset('assets/website')}}/images/blog-post-img-4.jpg" alt="">
								</figure>
							</div>
							<div class="swiper-pagination swiper-pagination-slider-format"></div>
							<span class="swiper-button-next-blog swiper-button-next"><i
									class="icon-left-arrow2"></i></span>
							<span class="swiper-button-prev-blog swiper-button-prev"><i
									class="icon-left-arrow"></i></span>
						</div>
						<div class="post-list__item-content">
							<header class="post-list__item-header">
								<div class="post-list__item-meta post-block_meta">
					...
					<article class="post-list__item format-audio">
						<figure class="thumbnail post-list__thumbnail audio-thumb">
							<iframe width="100%" height="450" scrolling="no" frameborder="no"
								src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/197377286&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true"></iframe>
						</figure>
						<div class="post-list__item-content">
							<header class="post-list__item-header">
								<div class="post-list__item-meta post-block_meta">
					...
					<article class="post-list__item format-link">
						<figure class="thumbnail post-list__thumbnail link-thumb">
							<a href="single-post.html"><img src="{{asset('assets/website')}}/images/blog-post-img-5.jpg" alt=""></a>
							<a href="{{route('index')}}" class="post-link">http://www.rentalcarslink.com</a>
						</figure>
						<div class="post-list__item-content">
							<header class="post-list__item-header">
								<div class="post-list__item-meta post-block_meta">
								...
								<h3 class="post-list__item-title">The Fee Detective and the Grace of Rental Car
									Companies</h3>
								<span class="post-list__item-author">by <a href="#">Paul Johnson</a></span>
							</header>
							<div class="post-list__item-desc">
					...
					<div class="sidebar-block">
						...
						<div class="post-block">
							<figure class="thumbnail">
								<a href="single-post.html"><img src="{{asset('assets/website')}}/images/post-thumb_small-1.jpg" alt=""></a>
							</figure>
						...
						<div class="post-block">
							<figure class="thumbnail">
								<a href="single-post.html"><img src="{{asset('assets/website')}}/images/post-thumb_small-2.jpg" alt=""></a>
							</figure>
							<div class="post-block__content">
								<div class="post-block_meta">
									<span class="date"><i class="icon-clock"></i> 10 February, 2017</span>
